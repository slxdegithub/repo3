        ...
        <table class="table-striped">
            ...
            <c:forEach items="${serviceInfoList}" var="serviceInfo" varStatus="status">
                <tr>
                    ...
                    <td class="todo-list">
                        <div class="tools">
                            <span class="iconfont icon-shenhejieguo" style=" color: #1945dd;cursor:pointer;font-weight: bold;font-size: 15px;" title="订阅审核" onclick="audit('${subscribeList[status.index].id}')"></span>
                        </div>
                    </td>
                </tr>
            </c:forEach>
    ...
    <div class="modal-dialog" role="document" style="width:350px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">服务订阅申请审核</h4>
            </div>
...
<script>
    ...
    function homePage(){
        ...
        if(findType=="0"){
            window.location.href="${pageContext.request.contextPath}/subscribeList?pageNo=1&findType="+findType+"&pageSize="+$("#pageSize").val();
            ...
            window.location.href="${pageContext.request.contextPath}/subscribeList?pageNo=1&findType="+findType+"&name="+searchName+"&pageSize="+$("#pageSize").val();
        }else{
            ...
            if(time.replace(/(^\s*)|(\s*$)/g, "").length ==0){
                ...
                window.location.href="${pageContext.request.contextPath}/subscribeList?pageNo=1&findType="+findType+"&range="+time+"&pageSize="+$("#pageSize").val();
            }
    ...
    function previousPage(pageNo){
        var findType=$("#findType").val();
        if(findType=="0"){
            window.location.href="${pageContext.request.contextPath}/subscribeList?pageNo="+pageNo+"&findType="+findType+"&pageSize="+$("#pageSize").val();
        }else if(findType=="1"||findType=="2"){
            var searchName=$("#searchName").val();
            if(searchName==''){
                if(findType=="1") {
            ...
            window.location.href="${pageContext.request.contextPath}/subscribeList?pageNo="+pageNo+"&findType="+findType+"&name="+searchName+"&pageSize="+$("#pageSize").val();
        }else{
            var time=$("#logDate").val();
            if(time.replace(/(^\s*)|(\s*$)/g, "").length ==0){
                $.alert({
                ...
                window.location.href="${pageContext.request.contextPath}/subscribeList?pageNo="+pageNo+"&findType="+findType+"&range="+time+"&pageSize="+$("#pageSize").val();
            }
    ...
    function auditApply() {
        ...
        $.ajax({
            url : "${pageContext.request.contextPath}/sub/subAudit",
            async : true,
            type : "POST",
            dataType : "json",
            data : {
        ...
        if(findType==0){
            ...
            if(searchName.replace(/(^\s*)|(\s*$)/g, "").length ==0&&findType!=3){
                ...
                if(findType==1){//根据名称查询
                    window.location.href="${pageContext.request.contextPath}/subscribeList?name="+searchName+"&findType=1&pageNo=1&pageSize="+$("#pageSize").val();
                }else if(findType == 2){
                    window.location.href="${pageContext.request.contextPath}/subscribeList?name="+searchName+"&findType=2&pageNo=1&pageSize="+$("#pageSize").val();
                }else if(findType == 3){
                    ...
                    if(time.replace(/(^\s*)|(\s*$)/g, "").length ==0){
                        ...
                        window.location.href="${pageContext.request.contextPath}/subscribeList?range="+time+"&findType=3&pageNo=1&pageSize="+$("#pageSize").val();
                    }
                }
            }
        }
    ...
    $("#pageSize").change(function(){
        ...
        window.location.href="${pageContext.request.contextPath}/subscribeList?findType=0&pageNo=1&pageSize="+pageSize;
