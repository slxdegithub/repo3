...
<div class="modal fade bs-example-modal-lg" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script>
        ...
        function homePage(){
            ...
            if(findType=="0"){
                window.location.href="${pageContext.request.contextPath}/myAnalysis?pageNo=1&findType="+findType+"&pageSize="+$("#pageSize").val();
                ...
                window.location.href="${pageContext.request.contextPath}/myAnalysis?pageNo=1&findType="+findType+"&name="+searchName+"&pageSize="+$("#pageSize").val();
            }else{
                ...
                window.location.href="${pageContext.request.contextPath}/myAnalysis?pageNo=1&findType="+findType+"&range="+logDate+"&pageSize="+$("#pageSize").val();
            }
        }
        function previousPage(pageNo){
            var findType=$("#findType").val();
            if(findType=="0"){
                window.location.href="${pageContext.request.contextPath}/myAnalysis?pageNo="+pageNo+"&findType="+findType+"&pageSize="+$("#pageSize").val();
            }else if(findType=="1"||findType=="2"){
                var searchName=$("#searchName").val();
                if(searchName==''){
                    if(findType=="1") {
                ...
                window.location.href="${pageContext.request.contextPath}/myAnalysis?pageNo="+pageNo+"&findType="+findType+"&name="+searchName+"&pageSize="+$("#pageSize").val();
            }else{
                var logDate=$("#logDate").val();
                if(logDate==''){
                    $.alert({
                ...
                window.location.href="${pageContext.request.contextPath}/myAnalysis?pageNo="+pageNo+"&findType="+findType+"&range="+logDate+"&pageSize="+$("#pageSize").val();
            }
        }
            ...
            if(findType==0){
                ...
                if(searchName.replace(/(^\s*)|(\s*$)/g, "").length ==0&&findType!=3){
                    ...
                    if(findType==1){//根据名称查询
                        window.location.href="${pageContext.request.contextPath}/myAnalysis?name="+searchName+"&findType=1&pageNo=1&pageSize="+$("#pageSize").val();
                    }else if(findType == 2){
                        window.location.href="${pageContext.request.contextPath}/myAnalysis?name="+searchName+"&findType=2&pageNo=1&pageSize="+$("#pageSize").val();
                    }else if(findType == 3){
                        ...
                        if(time.replace(/(^\s*)|(\s*$)/g, "").length ==0){
                            ...
                            window.location.href="${pageContext.request.contextPath}/myAnalysis?range="+time+"&findType=3&pageNo=1&pageSize="+$("#pageSize").val();
                        }
                    }
                }
            }
        ...
        $("#pageSize").change(function(){
            ...
            window.location.href="${pageContext.request.contextPath}/myAnalysis?findType=0&pageNo=1&pageSize="+pageSize;
        });
    </script>
</body>
</html>
